...
@endif --}}
<form action="{{route('ratingUpdate',['update_id'=>$ratingRecord->id])}}" method="post" class="needs-validation" novalidate>
    @csrf
    <div class="card-body">
        <div class="row g-3">
    ...
    <div class="col-md-6">
       <label>Rating</label>
         ...
         <div id="star-rating">
          ...
          <input type="hidden" name="rating" value="{{old('rating') ,$ratingRecord->rating}}" id="rating-value" >
          ...
          @error('rating')
            ...
            <div class="col-md-6 mt-4">
               <label>Review</label>
                  <textarea name="review" class="form-control ">{{$ratingRecord->review}}</textarea>
               <span style="color: red">
                  @error('review')
                   {{$message}}
                @enderror
