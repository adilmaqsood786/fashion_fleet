...
@section('content')
 <div class="card-header">
                  ...
                  <!--end::Header-->
                  <!--begin::Form-->
                  <form action="{{route('productUpdate',['update_id'=>$productRecord->id])}}" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
                    <!--begin::Body-->
                    @csrf
                    <div class="card-body">
                      <!--begin::Row-->
                      <div class="row g-3">
                        ...
                        <div class="col-md-6">
                          ...
                          <input type="text" class="form-control" value="{{old('name',isset($productRecord->name)?$productRecord->name:"")}}" name="name" required />
                          <span style="color: red">
                            @error('name')
                                {{$message}}
                            @enderror
                        ...
                        <div class="col-md-6">
                          ...
                          <input type="text" class="form-control" value="{{old('short_description',isset($productRecord->short_description)?$productRecord->short_description:"")}}" name="short_description" required />
                          <span style="color: red">
                        ...
                        <div class="col-md-6">
                          ...
                          <div class="input-group has-validation">
                            ...
                            <input type="text" class="form-control" value="{{old('description',isset($productRecord->description)?$productRecord->description:"")}}" name="description" required />
                        ...
                        <div class="col-md-6">
                          ...
                          <input type="text" class="form-control" value="{{old('sku',isset($productRecord->sku)?$productRecord->sku:"")}}" name="sku" required />
                          <span style="color: red">
                            @error('sku')
                                {{$message}}
                            @enderror
                        ...
                        <div class="col-md-6">
                          ...
                          <input type="number" class="form-control" value="{{old('price',isset($productRecord->price)?$productRecord->price:"")}}" name="price" required />
                          <span style="color: red">
                            @error('price')
                                {{$message}}
                            @enderror
                        ...
                        <div class="col-md-6">
                          ...
                          <input type="number" class="form-control" name="sale_price" value="{{old('sale_price',isset($productRecord->sale_price)?$productRecord->sale_price:"")}}" required />
                          <span style="color: red">
                            @error('sale_price')
                                {{$message}}
                            @enderror
                        ...
                        <div class="col-md-6">
                          ...
                          <input type="text" class="form-control" value="{{old('stock',isset($productRecord->stock)?$productRecord->stock:"")}}" name="stock" required />
                          <span style="color: red">
                            @error('stock')
                                {{$message}}
                            @enderror
                        ...
                        <div class="col-md-6">
                          ...
                          <input type="file" value="{{old('main_image',isset($productRecord->main_image)?$productRecord->main_image:"")}}" class="form-control" name="main_image" required />
                          <div class="valid-feedback">Looks good!</div>
                          <span style="color: red">
                            @error('main_image')
                                {{$message}}
